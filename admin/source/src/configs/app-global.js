export const PROJECT_NAME = 'Ceyres marketplace';
export const BASE_URL = 'https://api.ceyres.com';
export const WEBSITE_URL = 'https://ceyres.com';
...
export const RECAPTCHASITEKEY = '6LfqovkqAAAAAP85krqV0XhiawABXu_aeNdymHLQ';
